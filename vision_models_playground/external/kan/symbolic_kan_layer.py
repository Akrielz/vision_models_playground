...
class SymbolicKANLayer(nn.Module):
    ...
    def __init__(self, in_dim=3, out_dim=2, device='cpu'):
        ...
        Example
        -------
        >>> sb = SymbolicKANLayer(in_dim=3, out_dim=3)
    ...
    def forward(self, x):
        ...
        Example
        -------
        >>> sb = SymbolicKANLayer(in_dim=3, out_dim=5)
    ...
    def get_subset(self, in_id, out_id):
        ...
        Example
        -------
        >>> sb_large = SymbolicKANLayer(in_dim=10, out_dim=10)
    ...
    def fix_symbolic(self, i, j, fun_name, x=None, y=None, random=False, a_range=(-10, 10), b_range=(-10, 10), verbose=True):
        ...
        >>> sb = SymbolicKANLayer(in_dim=3, out_dim=2)
